...
import 'event_detail_page.dart'; // Import your EventDetailPage
...
class _HomePageState extends State<HomePage> {
  ...
  void addEvent(Map<String, String> newEvent) {
    setState(() {
      ...
      displayedEvents = allEvents;  // Update the displayed list
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // Pass the onAddEvent function when navigating to AddEventPage
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddEventPage(onAddEvent: addEvent), // Pass addEvent function
            ),
          );
        },
